...
:exe  'highlight  MatchParen      guifg='.yellow.'   guibg='.ui_4.'        guisp=NONE        gui=bold       ctermfg=red   ctermbg=NONE  cterm=bold'
...
:exe  'highlight  Terminal        guifg='.ui_1.'     guibg='.ui_12.'   guisp='.ui_12.'   gui=bold       ctermfg=189   ctermbg=235   cterm=bold'
